...
module.exports = orm.express(config.orm, {
    define: function (db, models, callback) {
        ...
        models.bubbles.hasOne("company", models.companies, { reverse: "bubbles", autoFetch: true });
        models.bubbles.purchases.hasOne("owner", models.users);
        models.bubbles.purchases.hasOne("bubble", models.bubbles, { autoFetch: true });
        models.bubbles.purchases.hasOne("shared", models.bubbles.purchases, { autoFetch: true });
